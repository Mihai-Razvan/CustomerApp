...
public class IndexesDifferenceAdapter extends RecyclerView.Adapter<IndexesDifferenceAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View view) {
            super(view);
            card_year = view.findViewById(R.id.index_difference_card_year_TW);
            card_month = view.findViewById(R.id.index_difference_card_month_TW);
            card_difference = view.findViewById(R.id.index_difference_card_difference_TW);
        }
    }
