...
public class HttpRequestsAuthentication implements Runnable, HttpRequestBasics{
    ...
    private int loginResponseCode;  //is -3 if client doesn't exist, -2 if password is wrong,-1 if dbconnection failed, 0 if failed to connect to server, clientId if login details a
